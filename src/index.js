...
import GalleryDetails from "./elements/gallery-details";
                ...
                <PageScrollTop>
                    <Switch>
                        ...
                        <Route exact path={`${process.env.PUBLIC_URL}/portfolio-details/:id`} component={PortfolioDetails}/>
                         <Route exact path={`${process.env.PUBLIC_URL}/product-details/:id`} component={ProductDetails}/>    <Route exact path={`${process.env.PUBLIC_URL}/gallery-details/:id`} component={GalleryDetails}/>
